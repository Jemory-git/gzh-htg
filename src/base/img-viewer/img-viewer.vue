...
// 使用说明： 此查看器需要enlargeImg.js来获取页面中所有的图片。然后在需要放大图片的组件中图片数据回来后发射imgsrcgot事件通知main.js来获取图片。
...
// 当点击事件发生时，执行App.vue中的相关方法
// App.vue中watch$route，切换页面后要重置currentIndex1的值
// main.js中取图片之前要先清掉查看器里的图片，因为这些图片并不需要
